...
.PHONY: build build-all generate verify-generate build-macos build-linux update-deps test setup-hooks clean test-diff test-share-sync test-daemon test-plan-daemon e2e e2e-failed e2e-report
